...
sensors = [
  ...
  { name: "a4d1s2", description: "Sensor 2", device: Device.find_by(name: "a4d1") },
  { name: "a4d1s3", description: "Sensor 3", device: Device.find_by(name: "a4d1") },
  { name: "a4d2s1", description: "Sensor 1", device: Device.find_by(name: "a4d2") },
  { name: "a4d2s2", description: "Sensor 2", device: Device.find_by(name: "a4d2") },
  { name: "a4d2s3", description: "Sensor 3", device: Device.find_by(name: "a4d2") },
  ...
  { name: "a5d2s1", description: "Sensor 1", device: Device.find_by(name: "a5d2") },
  ...
  { name: "a9d1s2", description: "Sensor 2", device: Device.find_by(name: "a9d1") },
  { name: "a9d1s3", description: "Sensor 3", device: Device.find_by(name: "a9d1") },
  { name: "a9d2s1", description: "Sensor 1", device: Device.find_by(name: "a9d2") },
  { name: "a9d2s2", description: "Sensor 2", device: Device.find_by(name: "a9d2") },
  { name: "a9d2s3", description: "Sensor 3", device: Device.find_by(name: "a9d2") },
  { name: "a11d1s1", description: "Sensor 1", device: Device.find_by(name: "a11d1") },
  { name: "a11d1s2", description: "Sensor 2", device: Device.find_by(name: "a11d1") },
  { name: "a11d1s3", description: "Sensor 3", device: Device.find_by(name: "a11d1") },
  { name: "a11d2s1", description: "Sensor 1", device: Device.find_by(name: "a11d2") },
  { name: "a11d2s2", description: "Sensor 2", device: Device.find_by(name: "a11d2") },
  { name: "a11d2s3", description: "Sensor 3", device: Device.find_by(name: "a11d2") }
]
